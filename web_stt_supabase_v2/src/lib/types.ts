...
// Renamed from FirestoreConnection during the Supabase migration. The shape
// is unchanged — Realtime subscription states map onto the same values.
export type SessionConnection = "connecting" | "live" | "missing" | "error";
